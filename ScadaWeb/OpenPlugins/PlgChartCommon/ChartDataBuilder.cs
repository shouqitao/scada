...
namespace Scada.Web.Plugins.Chart {
    ...
    /// <para>Builds JavaScript properties and data graphics</para>
    /// </summary>
    public class ChartDataBuilder {
        private int cnlCnt; // number of channels


        /// <summary>
        /// Provides input channel data formatting.
        /// </summary>
        ...
        /// <summary>
        /// Channel numbers of the displayed graphics
        /// </summary>
        protected int[] cnlNums;

        /// <summary>
        /// Start Date Displayed Data
        /// </summary>
        protected DateTime startDate;

        /// <summary>
        /// Period of the displayed data, days
        /// </summary>
        /// <remarks>If the period is negative, the time interval to the left of the start date is used.</remarks>
        ...
        public DateTime EndDate {
            get { return StartDate.AddDays(Period - 1); }
        }
        ...
        public string ToJs() {
            ...
            sbJs
                ...
                .Append("displaySettings.chartGap = ").Append(chartGap)
                .AppendLine(" / scada.chart.const.SEC_PER_DAY;")
                .AppendLine();
            ...
            sbJs
                ...
                .AppendFormat("{0}, {1}, {2}", startDate.Year, startDate.Month - 1, startDate.Day)
                .AppendLine(");")
            ...
            for (int i = 0; i < cnlCnt; i++) {
                ...
                sbJs
                    ...
                    .Append(single
                        ? GetTrendPointsJs(singleTrend, cnlPropsArr[i])
                        : GetTrendPointsJs(trendBundle, i))
                    .AppendLine(";")
                    .AppendLine();
            }
