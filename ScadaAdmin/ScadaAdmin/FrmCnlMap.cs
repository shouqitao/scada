...
namespace ScadaAdmin {
    ...
    /// <summary>
    /// Channel map form
    /// <para>Channel map form</para>
    /// </summary>
    public partial class FrmCnlMap : Form {
        /// <summary>
        /// Delegate receiving channels by item number
        /// </summary>
        ...
        /// <summary>
        /// To form a row of channel numbers
        /// </summary>
        ...
        private void AppendCnlNum(StringBuilder sbLine, int cnlNum1, int cnlNum2, ref int lineLen) {
            ...
            if (lineLen >= 50 /*Max. string length*/) {
